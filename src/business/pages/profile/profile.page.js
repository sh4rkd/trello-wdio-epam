...
class ProfilePage extends Page {
    constructor() {
        super();
        this.profileIcon = new Button('[data-testid="header-member-menu-button"],[aria-label="Open member menu"] img, .js-open-header-member-menu', 'Profile Icon');
        this.settingsOption = new Button('[data-testid="account-menu-settings"], [href*="/settings"]', 'Settings Option');
        this.profileVisibilityOption = new Button('[data-testid="menu-profile"], .js-member-profile, [href*="/manage-profile"]', 'Profile Visibility Option');
        ...
        this.saveButton = new Button('button[type="submit"], [data-testid="profile-save"]', 'Save Button');
        this.savedConfirmation = new Element('div[role="alert"], [class*="alert"]', 'Saved Confirmation');
        this.usernameError = new Element('#SaveProfileError_Field_username, [data-testid="username-error"], .error-message', 'Username Error');
        this.profileForm = new Element('[data-testid="profile-tab-container"], .profile-form, div[class*="profileContainer"]', 'Profile Form');
        this.userProfileLink = new Element('a[href*="/u/"], [data-testid="member-name"]', 'User Profile Link');
    }
